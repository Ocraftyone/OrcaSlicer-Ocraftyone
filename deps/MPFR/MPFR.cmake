...
if (MSVC)
    ...
    ExternalProject_Add(dep_MPFR
        ...
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND touch aclocal.m4 configure Makefile.ac Makefile.in;env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --prefix=${DESTDIR}/usr/local --enable-shared=no --enable-static=yes --with-gmp=${DESTDIR}/usr/local ${_gmp_build_tgt}
