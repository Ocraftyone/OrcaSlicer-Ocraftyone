...
void TabFilament::toggle_options()
{
    ...
    if (m_active_page->title() == L("Filament"))
    {
        ...
        auto support_multi_bed_types_opt = ToggleExpr::FromConfigBool(&printer_cfg, "support_multi_bed_types");
        ...
        auto is_pellet_printer = ToggleExpr::FromConfigBool(&printer_cfg, "pellet_modded_printer");
        toggle_line("pellet_flow_coefficient", is_pellet_printer);
        toggle_line("filament_diameter", !is_pellet_printer);

        toggle_line("chamber_temperature", ToggleExpr::FromConfigBool(&printer_cfg, "support_chamber_temp_control"));
    ...
    if (m_active_page->title() == L("Multimaterial")) {
        ...
        toggle_line("retraction_distances_when_ec", is_BBL_multi_extruder && long_retractions_ec, 256 + extruder_idx);
    }
}
